...
class Apipwc extends CI_Controller {
    ...
    public function login()
    {
      ...
      {
            //AHORA
            $correo_usuario = $this->data->correo_usuario; //obtengo el dato correo_usuario del json
            $password_usuario = sha1($this->data->password);   //obtengo el dato password del json
    ...
    try
    {    
        $aquien = $this->data->aquien;                             //cambiar a json
    ...
    public function guardarUsuario(){
        ...
        $data['apellido'] = $this->data->apellido;
        $data['correo'] = $this->data->correo;
        $data['password'] = sha1($this->data->passoword);
        $data['es_usuario'] = 1;
        $data['es_invitado'] = 0;
