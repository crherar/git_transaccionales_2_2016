...
$cabecera = array('formulario' => 'tnrore',
									'id_usuario_logueado' => $_SESSION["id_usuario_logueado"],
									 'email'=>$_SESSION["email"]);
$msg = json_encode(array('cabecera'=>$cabecera,'datos'=>$usuario));
$sock_data = socket_write($socket_tnr, $msg, strlen($msg));
$resp = json_decode(socket_read($socket_tnr, 16384));
$_SESSION["tnrore"] = $resp->datos;
print_r("total_reputaciones_de_usuario: ".$resp->datos);
