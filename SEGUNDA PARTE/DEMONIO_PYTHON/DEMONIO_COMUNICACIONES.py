    ...
    for s in inputready:
        ...
        if s == server:
            ...
            if formulario == "actrep":
                rep = reputaciones.reputaciones()
                print formulario
                respuesta = rep.actualizar_reputacion(data)
                del rep
                if respuesta:
                    print "respuesta al php: "
                    print respuesta
            ...
            if formulario == "vemrep":
                rep = reputaciones.reputaciones()
                print formulario
                respuesta = rep.mi_perfil_mis_reputaciones(data)
                del rep
                if respuesta:
                    print "respuesta al php: "
                    print respuesta
            ...
            if formulario == "delrep":
                rep = reputaciones.reputaciones()
                print formulario
                respuesta = rep.eliminar_reputacion(data)
                del rep
                if respuesta:
                    print "respuesta al php: "
                    print respuesta
